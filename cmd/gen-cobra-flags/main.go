...
// Usage:
//
//	gen-cobra-flags -input <dir> -output <dir> -package <name> [-struct <Name>] [-source-import <path>] [-same-package]
//
...
// The -same-package flag forces this behavior regardless of directories.
...
func main() {
	var (
		...
		samePackage  = flag.Bool("same-package", false, "force same-package mode: no source-package import or qualifier in generated code")
	)
	flag.Parse()
	...
	if err := run(generator.Options{
		...
		SamePackageAsSource: *samePackage,
	}); err != nil {
